...
bot_token = os.getenv('1204748326:AAHPlT7hspxKXJXCCTM7iDym6GNo43UpGJo')
api_id = int(os.getenv('924859'))
api_hash = os.getenv('a4c9a18cf4d8cb24062ff6916597f832')
